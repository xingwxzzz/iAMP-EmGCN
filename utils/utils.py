...
def load_corpus(dataset_str):
    ...
    objects = []
    for i in range(len(names)):
        with open("./cross_validation_data/fold_9/data/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
            if sys.version_info > (3, 0):
                objects.append(pkl.load(f, encoding='latin1'))
            else:
                objects.append(pkl.load(f))
    ...
    train_idx_orig = parse_index_file(
        "./cross_validation_data/fold_9/data/{}.train.index".format(dataset_str))
...
def load_corpus1(dataset_str):
    ...
    objects = []
    for i in range(len(names)):
        with open("./test_data/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
            if sys.version_info > (3, 0):
                objects.append(pkl.load(f, encoding='latin1'))
            else:
                objects.append(pkl.load(f))
    ...
    train_idx_orig = parse_index_file(
        "./test_data/{}.train.index".format(dataset_str))
    train_size = len(train_idx_orig)
